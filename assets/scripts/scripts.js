...
typewriter.typeString('hey there!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is dawna.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm a student at uc san diego (go tritons!).")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm studying cognitive science")
    .pauseFor(500)
    .deleteAll()
    .pauseFor(500)
    .typeString("specializing in machine learning & neural computation.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm also interested in 3D modeling.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("fan of legos and funkos.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i also like to play VR games.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
